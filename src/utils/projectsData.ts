...
import bookCollectionInstitucional from "../assets/projects-image/mock-book-collection-instiucional.png";
import bookColllectionAPP from "../assets/projects-image/mock-book-collection-app.png";
...
export const projectsData: Project[] = [
  {
    ...
    title: "GuardianEye",
    description:
      "Projeto da disciplina de Banco de Dados II: Criação de um aplicativo frontend e banckend, com Node.js, Express, Mongoose, MongoDB Atlas e AuraDB",
    image: guadianEye,
    info: [
      "Sistema Web com front-end e back-end",
      "Frontend: HTML, CSS and JavaScript",
      "Backend: Express, JavaScript, Mongo and Neo4j",
      "Consumo de APIs externas (Leaflet e Mongo Charts)",
      "Consumo da API do próprio sistema",
      "Sistema poliglota (MongoDB e Neo4j)",
    ],
  ...
  },
  {
    ...
    title: "Asclepius",
    description:
      "Projeto de Programação Web I: Desenvolvimento de uma API Rest, com TypeScript, Node.js e Prisma, trabalhando os conceitos de CRUD, autenticação e upload de arquivos",
    image: asclepius,
    info: [
      "API REST desenvolvida com Prisma e Typescript",
  ...
  },
  {
    ...
    description:
      "Jogo feito com Java, consiste em um clássico arcade de batalha espacial",
    image: space,
    info: [
      "Jogo desenvolvido para desktop",
      "Aplicação desenvolvida com Java",
      "Uso do Java Swing para gerar o design",
    ],
    category: ["all", "app"],
  ...
  },
  {
    ...
    title: "Asclepius APP",
    description:
      "Projeto de Programação para Dispositivos Móveis: Desenvolvimento de uma APP, com TypeScript, React-Native, com ligação a uma API previamente desenvolvida no projeto de Programação para Web I.",
    image: asclepiusApp,
    info: [
      "Aplicação móvel desenvolvida com React-Native",
      "Uso de API externa",
      "Uso de TypeScript",
    ],
    category: ["all", "app"],
  },
  {
    ...
    image: asclepiusWeb,
    info: [
      "Sistema web desenvolvido com React",
      "Uso de TypeScript",
      "Uso de API externa",
    ],
    category: ["all", "web"],
  ...
  {
    id: 6,
    title: "Book Collection TCC",
    description:
      "O sistema Book Collection foi um projeto web desenvolvido para o meu Trabalho de Conclusão de Curso (TCC). O sistema Book Collection é uma rede social voltada para leitores, permitindo interação entre usuários, organização de leituras e descoberta de novas aventuras literárias.",
  ...
  },
  {
    ...
    title: "Nova Studio",
    description:
      "A Nova Studio é uma empresa de desenvolvimento de software que fundei com o objetivo de criar soluções inovadoras e personalizadas para nossos clientes. Nossa missão é transformar ideias em realidade, oferecendo serviços de alta qualidade em desenvolvimento web, aplicativos móveis e consultoria tecnológica.",
    image: novaStudio,
    info: [
      "Empresa de desenvolvimento de software",
      "Focada em soluções personalizadas",
  ...
  },
  {
    ...
    link: "https://book-collection-institutional-v1.pages.dev/",
  },
  {
    id: 12,
