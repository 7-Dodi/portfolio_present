...
export const Project:React.FC<Props> = ({image, title, description, link, info}) => {
    ...
    return (
      <div className="portifolioProjeto">
        ...
        <span
          className="projetoButton"
          onClick={() => handleSetStateProject(true)}
        >
          Ver mais
        ...
        <div
          className={
            toggleStateProject === true
              ? "projetoModal projetoModal-active"
              : "projetoModal"
          }
        >
          <div className="projetoModal-content">
            <i
              className="uil uil-times projetoModal-close"
              onClick={() => handleSetStateProject(false)}
            ></i>
            <h3 className="projetoModal-title">{title}</h3>
            <p
              className="projetoModel-description"
            ...
            <ul className="projetoModal-projetos grid">
              ...
              {link && (
                <li className="projetoModal-projeto">
                  ...
                  <p className="projetoModal-info projetoModal-link">
                    Link do projeto:{" "}
                    <a href={link} target="_blank">
                      <strong>Clique aqui para acessar!</strong>
                    </a>
                  </p>
                </li>
              )}
